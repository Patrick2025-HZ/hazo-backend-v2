...
export class InitialMigration1760154999247 implements MigrationInterface {
    name = 'InitialMigration1760154999247'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "post" DROP COLUMN "media_url"`);
        await queryRunner.query(`ALTER TABLE "post" ADD "media_url" jsonb`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_e12875dfb3b1d92d7d7c5377e2"`);
        await queryRunner.query(`ALTER TABLE "post" DROP COLUMN "media_url"`);
        await queryRunner.query(`ALTER TABLE "post" ADD "media_url" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "user" DROP COLUMN "updatedAt"`);
        await queryRunner.query(`ALTER TABLE "user" DROP COLUMN "createdAt"`);
        await queryRunner.query(`ALTER TABLE "user" DROP COLUMN "isActive"`);
        await queryRunner.query(`ALTER TABLE "user" DROP COLUMN "deletedAt"`);
