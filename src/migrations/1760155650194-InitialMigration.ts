...
export class InitialMigration1760155650194 implements MigrationInterface {
  name = 'InitialMigration1760155650194';
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "post" DROP COLUMN "media_url"`);
    await queryRunner.query(
      `ALTER TABLE "post" ADD "media_url" character varying NOT NULL`,
    );
    await queryRunner.query(`ALTER TABLE "user" DROP COLUMN "updatedAt"`);
    await queryRunner.query(`ALTER TABLE "user" DROP COLUMN "createdAt"`);
    await queryRunner.query(`ALTER TABLE "user" DROP COLUMN "isActive"`);
