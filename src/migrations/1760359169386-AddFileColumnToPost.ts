...
export class AddFileColumnToPost1760359169386 implements MigrationInterface {
  name = 'AddFileColumnToPost1760359169386';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "post" RENAME COLUMN "media_url" TO "file"`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "comments" DROP COLUMN IF EXISTS "file"`,
    );
    await queryRunner.query(`ALTER TABLE "comments" ADD "file" jsonb`);
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "comments" DROP COLUMN "file"`);
    await queryRunner.query(`ALTER TABLE "user" DROP COLUMN "updatedAt"`);
    await queryRunner.query(`ALTER TABLE "user" DROP COLUMN "createdAt"`);
    await queryRunner.query(`ALTER TABLE "user" DROP COLUMN "isActive"`);
    await queryRunner.query(`ALTER TABLE "user" DROP COLUMN "deletedAt"`);
    ...
    await queryRunner.query(
      `ALTER TABLE "post" RENAME COLUMN "file" TO "media_url"`,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_f2578043e491921209f5dadd08" ON "user" ("phoneNumber") `,
    );
